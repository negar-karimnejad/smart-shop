...
function Footer() {
  return (
    <div className="bg-slate-700 py-10 mt-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-10 text-white main-container">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-gray-300">
            ...
            me?” odds are Best Buy is your closest option. With more than 1,100
            electronics stores across the United States, and online at
